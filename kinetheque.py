...
Collect fluorescence data along a linear pressure gradient.
...
def parse_args(argv):
    ...
    parser.add_argument('-e', "--eq_min", help="minimum equilibration time (s)", type=int, default=30)
    parser.add_argument('-t', "--eq_max", help="maximum equilibration time/state timeout (s)", type=int, default=1200)
    ...
    parser.add_argument("--dewpoint", help="Chamber temperature at which windows will fog (˚C)", type=float, default=13.5)
