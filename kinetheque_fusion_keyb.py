...
press_lo = 0.7
# high pressure
press_hi = float(input("input target pressure in bar "))
...
print("press 'a' to begin data collection", end='')
keyboard.wait('a')
print('')
...
# start sweep
print("press 'a' to go to {} bar".format(press_hi), end='')
keyboard.wait('a')
print('')
pump_free.clear()
