...
file_data = "20200719_viscotest4.tsv"
...
def animate(i, t, temp_ext, temp_int, temp_set, pres_act, intensity):
...
ani = animation.FuncAnimation(fig, animate, fargs=(t, temp_ext, temp_int, temp_set, pres_act, intensity), interval=1000)
plt.show()
